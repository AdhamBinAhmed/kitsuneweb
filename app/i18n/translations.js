  ...
  zh: {
    ...
    changelog: {
      ...
      entries: [
        ...
        { version:"v30.6", date:"2026年1月14日", items:["更新 Kitsune 至 v30.6","Material 3 全新界面","增强隐藏","全新 SuList 模式逻辑","新包名","添加防启动循环保护","添加模块批量安装","添加模块备份/恢复","添加扩展 WebUI 引擎","添加在线模块搜索","添加独立模块安装器"] },
      ],
    },
    download: {
      offering: "奉納 · 献礼",
  ...
  ar: {
    ...
    changelog: {
      ...
      entries: [
        ...
        { version:"v30.6", date:"14 يناير 2026", items:["تحديث Kitsune إلى v30.6","واجهة Material 3 جديدة","إخفاء محسّن","منطق SuList جديد","اسم حزمة جديد","حماية من حلقة الإقلاع","تثبيت جماعي للموديلات","نسخ احتياطي / استعادة الموديلات","محرك WebUI موسّع","بحث الموديلات عبر الإنترنت","مثبت موديلات مستقل"] },
      ],
    },
    download: {
      offering: "奉納 · تقديم",
  ...
  hi: {
    ...
    changelog: {
      ...
      entries: [
        ...
        { version:"v30.6", date:"14 जनवरी 2026", items:["Kitsune को v30.6 में अपडेट","Material 3 नया UI","उन्नत छुपाव","नया SuList मोड लॉजिक","नया पैकेज नाम","बूटलूप सुरक्षा जोड़ी","मॉड्यूल बल्क इंस्टॉल","मॉड्यूल बैकअप / रिस्टोर","विस्तारित WebUI इंजन","ऑनलाइन मॉड्यूल सर्च","स्वतंत्र मॉड्यूल इंस्टॉलर"] },
      ],
    },
    download: {
      offering: "奉納 · अर्पण",
  ...
  bn: {
    ...
    changelog: {
      ...
      entries: [
        ...
        { version:"v30.6", date:"১৪ জানুয়ারি ২০২৬", items:["Kitsune v30.6-এ আপডেট","Material 3 নতুন UI","উন্নত হাইড","নতুন SuList মোড","নতুন প্যাকেজ নাম","বুটলুপ সুরক্ষা","বাল্ক মডিউল ইনস্টল","মডিউল ব্যাকআপ / রিস্টোর","এক্সটেন্ডেড WebUI","অনলাইন মডিউল সার্চ","স্বাধীন মডিউল ইনস্টলার"] },
      ],
    },
    download: {
      offering: "奉納 · নৈবেদ্য",
  ...
  ru: {
    ...
    changelog: {
      ...
      entries: [
        ...
        { version:"v30.6", date:"14 января 2026", items:["Обновление Kitsune до v30.6","Новый UI Material 3","Улучшенное скрытие","Новая логика SuList","Новое имя пакета","Защита от бутлупа","Массовая установка модулей","Бэкап / восстановление модулей","Расширенный WebUI","Онлайн-поиск модулей","Независимый установщик модулей"] },
      ],
    },
    download: {
  ...
  id: {
    ...
    changelog: {
      ...
      entries: [
        ...
        { version:"v30.6", date:"14 Januari 2026", items:["Update Kitsune ke v30.6","UI Material 3 baru","Enhanced Hide","Logika SuList baru","Nama paket baru","Perlindungan bootloop","Instalasi bulk modul","Backup / restore modul","Mesin WebUI diperluas","Pencarian modul online","Installer modul independen"] },
      ],
    },
    download: {
  ...
  ja: {
    ...
    changelog: {
      ...
      entries: [
        ...
        { version:"v30.6", date:"2026年1月14日", items:["Kitsuneをv30.6に更新","Material 3新UI","強化ハイド","新SuListモードロジック","新パッケージ名","ブートループ保護追加","モジュール一括インストール","モジュールバックアップ/復元","拡張WebUIエンジン","オンラインモジュール検索","独立モジュールインストーラー"] },
      ],
    },
    download: {
      offering: "奉納",
  ...
  tr: {
    ...
    changelog: {
      ...
      entries: [
        ...
        { version:"v30.6", date:"14 Ocak 2026", items:["Kitsune v30.6'ya güncellendi","Material 3 yeni UI","Gelişmiş gizleme","Yeni SuList modu","Yeni paket adı","Bootloop koruması","Toplu modül yükleme","Modül yedekleme / geri yükleme","Genişletilmiş WebUI","Çevrimiçi modül arama","Bağımsız modül yükleyici"] },
      ],
    },
    download: {
      offering: "奉納 · Sunu",
  ...
  ko: {
    ...
    changelog: {
      ...
      entries: [
        ...
        { version:"v30.6", date:"2026년 1월 14일", items:["Kitsune v30.6 업데이트","Material 3 새 UI","향상된 숨기기","새 SuList 모드","새 패키지명","부트루프 보호 추가","모듈 일괄 설치","모듈 백업/복원","확장 WebUI 엔진","온라인 모듈 검색","독립 모듈 설치 프로그램"] },
      ],
    },
    download: {
      offering: "奉納 · 봉납",
