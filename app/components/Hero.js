      ...
      <div className="relative mx-auto flex min-h-[100svh] max-w-5xl flex-col items-center justify-center px-5 pt-28 pb-16 text-center">
        ...
        <div className="animate-rise mt-10 flex flex-col items-center gap-4 sm:flex-row" style={{ animationDelay: "0.25s" }}>
          ...
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-gold/40 bg-lacquer px-8 py-4 font-semibold text-washi transition-colors hover:border-gold hover:bg-lacquer-2 sm:bg-lacquer/60 sm:backdrop-blur sm:w-auto"
          >
